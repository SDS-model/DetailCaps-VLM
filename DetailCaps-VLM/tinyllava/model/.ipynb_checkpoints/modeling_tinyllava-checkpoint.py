...
class TinyLlavaForConditionalGeneration(TinyLlavaPreTrainedModel):
    ...
    def load_EnhancedCMN(self,**kwargs):
        self.vision_tower.load_model_EnhancedCMN(**kwargs)
    def load_GlobalFeatureEnhancement(self,**kwargs):
        self.vision_tower.load_model_GlobalFeatureEnhancement(**kwargs)
    def load_MultiViewFeatureFusion(self,**kwargs):
        self.vision_tower.load_model_MultiViewFeatureFusion(**kwargs)
