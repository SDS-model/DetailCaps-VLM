...
class TinyLlavaForConditionalGeneration(TinyLlavaPreTrainedModel):
    ...
    def load_MSCORCH(self,**kwargs):
        self.vision_tower.load_model_MSCORCH(**kwargs)
    def load_SSA(self,**kwargs):
        self.vision_tower.load_model_SSA(**kwargs)
    def load_DSVAB(self,**kwargs):
        self.vision_tower.load_model_DSVAB(**kwargs)
